...
```
from rlstructures import SimpleAgent,DictTensor
import torch

class UniformAgent(SimpleAgent):
    def __init__(self,n_actions):
        super().__init__()
        self.n_actions=n_actions
    
    def __call__(self,state,observation,agent_info):        
...
These batchers are explained later
